...
- [ActiveCodegen](https://codegen.activej.io) - Dynamic bytecode generator, directly compiles Lisp-like AST tree expressions into bytecode, using automatic type inference with essentially zero overhead.
