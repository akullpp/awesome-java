...
- [Anahata ASI](https://github.com/anahata-os/anahata-asi) - Stateful, air-gapped Artificial Super Intelligence (ASI) container and JVM agent featuring metabolic context memory (CwGC) and in-process JIT-compiled tool generation.
