...
- [Hyper MinHash](https://github.com/LiveRamp/HyperMinHash-java) - A probabilistic data structure for computing union, intersection, and set cardinality in loglog space. 
