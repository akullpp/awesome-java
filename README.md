...
- [jwt-java](https://github.com/BastiaanJansen/jwt-java) - JSON Web Token implementation for Java according to RFC 7519. Easily create, parse and validate JSON Web Tokens using a fluent API.
