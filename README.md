...
- [SchemaCrawler](https://www.schemacrawler.com) - Database schema discovery, documentation, diagrams, and lint. Has an [MCP Server](https://github.com/schemacrawler/SchemaCrawler-AI-MCP-Server-Usage) for these functions too. Works with most relational databases.
