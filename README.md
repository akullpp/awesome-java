...
* [Greenmail](http://www.icegreen.com/greenmail/) - In-memory email server for testing integration testing email related operations. Supports SMTP, POP3 and IMAP including SSL 
