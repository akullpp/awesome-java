...
* [Derive4J](https://github.com/derive4j/derive4j) - JSR-269 code generator for algebraic data types, with support for laziness, structural pattern matching, fonctional setters and more.
