...
- [Artipie](https://github.com/artipie) - Binary artifact management toolkit written in reactive Java, it's open-source, database-free, horizontally scalable, supports Maven, Docker, Rubygems, Go, Helm, Npm, NuGet, Composer, Pypi, Rpm, Debian and others. Artifacts can be hosted on the file system or [Amazon S3](https://aws.amazon.com/s3/).
