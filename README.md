...
- [ActiveInject](https://inject.activej.io) - Lightweight and powerful DI library: support of nested scopes, singletons and transient bindings, modules, multi- and single-threaded Injectors.
...
- [LogicNG](https://github.com/logic-ng/LogicNG) - LogicNG Library for creating, manipulating and solving Boolean and Pseudo-Boolean formulas.
...
- [ActiveSerializer](https://serializer.activej.io) - Fast and space-efficient serialization library with schema-less approach for the best performance.
