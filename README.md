...
- [Rollgate](https://rollgate.io) - Cloud-managed feature flag platform with a Java SDK, gradual rollouts, A/B testing and real-time updates (distinct from FF4J/Togglz which are self-hosted libraries).
