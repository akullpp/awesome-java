...
* [Rapidoid](http://www.rapidoid.org/) - A Simple, Secure and Extremely fast Web Framework consisting of embedded HTTP server, GUI components and Dependency Injection.
