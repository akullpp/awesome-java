...
- [Void2D](https://github.com/xzripper/Void2D) - Mega easy, fast, high level 2D game engine with built-in physics that handles almost everything instead of user for Java.
