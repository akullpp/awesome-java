...
- [DevOpsForge](https://github.com/Gohar01/devops-config-generator) - Visual generator for Spring Boot Dockerfiles and Docker Compose configurations.
...
- [iban-commons](https://github.com/SpeedBankingDe/iban-commons) - Zero-dependency IBAN and BIC toolkit with allocation-free validation plus parsing and formatting for 127 countries.
...
- [Backbone Community](https://github.com/get-backbone/backbone-community) - SaaS platform foundation for Quarkus with built-in auth, metrics, throttling, fault tolerance and observability. Community Licence (source-available, non-production); commercial tiers unlock AWS production.
...
- [Norconex Crawler](https://github.com/Norconex/crawler) - Modular web and file-system crawler with embedded Java APIs, official Docker images and a browser-based configurator.
