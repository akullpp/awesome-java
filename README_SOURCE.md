...
- [ThreadMine](https://threadmine.dev/en) - Analyze JVM thread dumps from HotSpot, OpenJ9, Zing and GraalVM, with detection of deadlocks, pool exhaustion and virtual thread pinning. Free tier with paid plans.
