...
List<BadgeMapping> generateBadgeMappings(List<ProjectEntry> entries) {
  ...
  for (var entry : entries) {
    ...
    var starsBadge = "<img src=\"%s\" alt=\"GitHub stars\">".formatted(Constants.GITHUB_STARS_BADGE_URL.formatted(repo));

    var lastCommitBadge = "<img src=\"%s\" alt=\"Last commit\">".formatted(Constants.GITHUB_LAST_COMMIT_BADGE_URL.formatted(repo));
